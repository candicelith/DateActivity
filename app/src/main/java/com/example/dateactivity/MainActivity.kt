...
class MainActivity : AppCompatActivity(),
    android.app.DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener

{
        ...
        with(binding) {
            ...
            spinnerGender.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
                override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                    Toast.makeText(this@MainActivity, stringGender.get(p2),
    ...
    fun showTimepicker(view: View) {
        val timePicker = com.example.dateactivity.dialog.TimePicker()
    ...
    fun showAlert(view: View) {
        ...
        builder.setMessage("Halo saya dialog alert")
